...
| [全市场盘后选股推荐规格](recommendation-screener-spec.md) | 全市场股票池、盘后快照、规则筛选、推荐 CSV/元数据、调度、回测与落地阶段设计 |
| [分析上下文包契约、运行态消费与可见性](analysis-context-pack.md) | AnalysisContextPack 首版范围、字段质量状态、P1/P2 内部契约、P3 Prompt 摘要消费、P4 历史/API/Web 低敏可见性和源码锚点 |
