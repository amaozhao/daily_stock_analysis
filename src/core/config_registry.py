...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "RECOMMENDATION_ENABLED": {
        ...
        "description": "Enable full-market after-close A-share recommendation screening.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 13,
        "help_key": "settings.system.recommendation",
        "examples": ["RECOMMENDATION_ENABLED=true"],
        "docs": [
            {
                "label": "全市场盘后选股推荐规格",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/recommendation-screener-spec.md",
            },
        ],
        "warning_codes": ["restart_required"],
    },
    "RECOMMENDATION_SCHEDULE_TIME": {
        "title": "Recommendation Schedule Time",
        "description": "Daily recommendation run time in HH:MM format; use an after-close time for A-shares.",
        "category": "system",
        "data_type": "time",
        "ui_control": "time",
        "is_sensitive": False,
        ...
        "display_order": 14,
        "help_key": "settings.system.recommendation",
        "examples": ["RECOMMENDATION_SCHEDULE_TIME=15:30"],
        "docs": [
            {
                "label": "全市场盘后选股推荐规格",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/recommendation-screener-spec.md#调度",
            },
        ],
        "warning_codes": ["restart_required", "local_timezone"],
    },
    "RECOMMENDATION_RUN_IMMEDIATELY": {
        "title": "Recommendation Run Immediately",
        "description": "Run one recommendation task immediately when scheduler mode starts.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "display_order": 15,
        "help_key": "settings.system.recommendation",
        "examples": ["RECOMMENDATION_RUN_IMMEDIATELY=false"],
        "docs": [
            {
                "label": "全市场盘后选股推荐规格",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/recommendation-screener-spec.md#调度",
    ...
    "RECOMMENDATION_NOTIFY_ENABLED": {
        "title": "Recommendation Notify Enabled",
        "description": "Send a report-route notification summary after a recommendation run completes.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "display_order": 16,
        "help_key": "settings.system.recommendation",
        "examples": ["RECOMMENDATION_NOTIFY_ENABLED=true"],
        "docs": [
            {
                "label": "全市场盘后选股推荐规格",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/recommendation-screener-spec.md#api-与-web",
            },
        ],
        "warning_codes": ["restart_required"],
    },
    "RECOMMENDATION_LLM_REVIEW_ENABLED": {
        "title": "Recommendation LLM Review",
        "description": "Run existing per-stock deep analysis for Top recommendations as an LLM risk review.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "display_order": 17,
        "help_key": "settings.system.recommendation",
        "examples": ["RECOMMENDATION_LLM_REVIEW_ENABLED=false"],
        "docs": [
            {
                "label": "全市场盘后选股推荐规格",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/recommendation-screener-spec.md#llm-复核",
            },
        ],
        "warning_codes": ["model_quota", "restart_required"],
    },
    "RECOMMENDATION_DB_INDEX_ENABLED": {
        "title": "Recommendation DB Index",
        "description": "Sync recommendation run summaries into a DB index for pagination and search.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "display_order": 18,
        "help_key": "settings.system.recommendation",
        "examples": ["RECOMMENDATION_DB_INDEX_ENABLED=true"],
        "docs": [
            {
                "label": "全市场盘后选股推荐规格",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/recommendation-screener-spec.md#api-与-web",
    ...
    "RECOMMENDATION_MARKET": {
        "title": "Recommendation Market",
        "description": "Recommendation market; first version supports cn only.",
        "category": "system",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        ...
        "is_editable": True,
        "default_value": "cn",
        "options": [{"value": "cn", "label": "A-shares"}],
        "validation": {},
        "display_order": 19,
        "help_key": "settings.system.recommendation",
        "examples": ["RECOMMENDATION_MARKET=cn"],
        "docs": [
            {
                "label": "全市场盘后选股推荐规格",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/recommendation-screener-spec.md",
    ...
    "RECOMMENDATION_PROFILE": {
        ...
        "description": "Recommendation profile name used when RECOMMENDATION_PROFILE_PATH is not set.",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "beginner_cn",
        "options": [],
        "validation": {},
        "display_order": 20,
        "help_key": "settings.system.recommendation",
        "examples": ["RECOMMENDATION_PROFILE=beginner_cn"],
        "docs": [
            {
                "label": "全市场盘后选股推荐规格",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/recommendation-screener-spec.md#配置-profile",
            },
        ],
        "warning_codes": ["restart_required"],
    },
    "RECOMMENDATION_PROFILE_PATH": {
        "title": "Recommendation Profile Path",
        "description": "TOML recommendation profile path.",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "config/recommendation_profiles/beginner_cn.toml",
        "options": [],
        "validation": {},
        "display_order": 21,
        "help_key": "settings.system.recommendation",
        "examples": ["RECOMMENDATION_PROFILE_PATH=config/recommendation_profiles/beginner_cn.toml"],
        "docs": [
            {
                "label": "全市场盘后选股推荐规格",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/recommendation-screener-spec.md#配置-profile",
    ...
    "RECOMMENDATION_OUTPUT_DIR": {
        "title": "Recommendation Output Directory",
        "description": "Directory for recommendation snapshots, run CSV files, meta JSON and profile snapshots.",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "data/recommendations",
        "options": [],
        "validation": {},
        "display_order": 22,
        "help_key": "settings.system.recommendation",
        "examples": ["RECOMMENDATION_OUTPUT_DIR=data/recommendations"],
        "docs": [
            {
                "label": "全市场盘后选股推荐规格",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/recommendation-screener-spec.md#数据文件",
            },
        ],
        "warning_codes": ["restart_required"],
    },
    "RECOMMENDATION_SNAPSHOT_RETENTION_DAYS": {
        "title": "Recommendation Retention Days",
        "description": "Retention days for recommendation snapshots, run outputs and profile snapshots.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 23,
        "help_key": "settings.system.recommendation",
        "examples": ["RECOMMENDATION_SNAPSHOT_RETENTION_DAYS=90"],
        "docs": [
            {
                "label": "全市场盘后选股推荐规格",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/recommendation-screener-spec.md#数据保留与回测",
            },
        ],
        "warning_codes": ["restart_required"],
    },
