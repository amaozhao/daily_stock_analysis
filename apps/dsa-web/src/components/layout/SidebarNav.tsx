...
import { BarChart3, Bell, BriefcaseBusiness, Home, ListChecks, LogOut, MessageSquareQuote, Settings2 } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'recommendations', label: '推荐', to: '/recommendations', icon: ListChecks },
